package com.example.mici.view.custom
...
class SudokuBoardView(context: Context, attributeSet: AttributeSet) : View(context, attributeSet) {
    ...
    private fun drawText(canvas: Canvas){
        cells?.forEach {
            ...
            canvas.drawText(valueString,(col * cellSizePixels)+ cellSizePixels/2 - textWidth+10,
                (row*cellSizePixels) + cellSizePixels/2-textHeight+65,textPaint)
        }
    }
